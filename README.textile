...
SVGeocoder fills the lack of a forward geocoding class on iOS, and is an improved alternative to Apple's unreliable MKReverseGeocoder. It uses "TouchJSON":https://github.com/TouchCode/TouchJSON as well as the "Google Geocoding API":http://code.google.com/apis/maps/documentation/geocoding/ as its data provider so make sure you read their "Terms of Service":http://code.google.com/apis/maps/terms.html#section_10_12 before using SVGeocoder. 
...
On success, SVGeocoder will return an "MKPlacemark":http://developer.apple.com/library/ios/#documentation/MapKit/Reference/MKPlacemark_Class/Reference/Reference.html object:
