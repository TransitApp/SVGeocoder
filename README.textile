...
On success, SVGeocoder will return an SVPlacemark object (which is a  "MKPlacemark":http://developer.apple.com/library/ios/#documentation/MapKit/Reference/MKPlacemark_Class/Reference/Reference.html subclass with a @coordinate@ property — useful for forward geocoding):
